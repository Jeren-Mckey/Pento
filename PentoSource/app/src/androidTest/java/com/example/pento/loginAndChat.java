...
public class loginAndChat {
    ...
    public void loginAndChat() {
        ...
        ViewInteraction appCompatImageButton = onView(
                allOf(withId(R.id.profile_back),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Areeb132!"), closeSoftKeyboard());
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.group3), withText("Enter Group 3"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatImageButton2 = onView(
                allOf(withId(R.id.chat_back),
                        childAtPosition(
                                allOf(withId(R.id.upper_nav),
                                        childAtPosition(
